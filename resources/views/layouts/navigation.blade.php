        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="font-bold text-2xl text-blue-600">
                        Jobedia
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(Auth::user()->isSeeker())
                        ...
                        <x-nav-link :href="route('seeker.profile')" :active="request()->routeIs('seeker.profile')">
                            {{ __('My Profile') }}
                        </x-nav-link>
                    @endif

                    @if(Auth::user()->isEmployer())
                        <x-nav-link :href="route('employer.candidates')" :active="request()->routeIs('employer.candidates')">
                            {{ __('Find Talent') }}
                        </x-nav-link>
